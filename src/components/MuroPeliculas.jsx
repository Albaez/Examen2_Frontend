...
export const MuroPeliculas = () => {
  ...
  const EditarPelicula = (id) => {
    navigate(`/src/components/EditarPeliculas.jsx/${id}`);
  };

  const CrearPostHandler = () => {
    navigate("/src/components/CrearPeliculas.jsx");
  };
            ...
            <div className="card-header card border-success d-flex justify-content-end">
              ...
              <Dropdown>
                ...
                <Dropdown.Menu className="dropdown-menu-right">
                  <Dropdown.Item onClick={() => EditarPelicula(item.id)}>
                    Editar
                  </Dropdown.Item>
                  <Dropdown.Item onClick={() => borraPeliculas(item.id)}>
                    Borrar
                  </Dropdown.Item>
                </Dropdown.Menu>
              </Dropdown>
